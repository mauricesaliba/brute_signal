...
public class PathlossModel
{
    ...
    class WallObject{
        ...
        public WallObject(float X1, float X2, float Y1, float Y2, MaterialEnum Material, float Thickness){
            x1 = X1;
            x2 = X2;
            y1 = Y1;
            y2 = Y2;
    ...
    public PathlossModel.PathlossModelCache GenerateCache(WallObject walls[]){
        ...
        PathlossModel.PathlossModelCache cache = new PathlossModel.PathlossModelCache(dim_x, dim_y);
